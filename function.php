...
function base_url()
{
	return 'http://localhost/library_management_system/library_management_system/';
}
...
{
	$query = "
	SELECT party_name FROM lms_author 
	WHERE party_status = 'Enable' 
	...
	foreach($result as $row)
	{
		$output .= '<option value="'.$row["party_name"].'">'.$row["party_name"].'</option>';
	}
...
{
	$query = "
	SELECT location_name FROM lms_location
	WHERE location_status = 'Enable' 
...
function Count_total_book_number($connect)
{
	...
	$query = "
	SELECT COUNT(product_id) AS Total FROM lms_book 
...
function Count_total_author_number($connect)
{
	...
	$query = "
	SELECT COUNT(party_id) AS Total FROM lms_author 
	WHERE party_status = 'Enable'
	";
...
function Count_total_location_rack_number($connect)
{
	...
	$query = "
	SELECT COUNT(location_id) AS Total FROM lms_location
	WHERE location_status = 'Enable'
	";
