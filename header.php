                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="author.php">Party</a>
                            <a class="nav-link" href="location_rack.php">Location</a>
                            <a class="nav-link" href="book.php">Products</a>
                            <a class="nav-link" href="user.php">User</a>
                            <a class="nav-link" href="issue_book.php">Issue</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-inline mt-4 float-end">
                                ...
                                <li class="list-inline-item"><a href="issue_book_details.php">Issue</a></li>
                                <li class="list-inline-item"><a href="search_book.php">Search Product</a></li>
