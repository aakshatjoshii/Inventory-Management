		...
		<div class="col-xl-3 col-md-6">
			<div class="card bg-primary text-white mb-4">
				<div class="card-body">
					...
					<h5 class="text-center">Total Product Issue</h5>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-md-6">
			<div class="card bg-warning text-white mb-4">
				<div class="card-body">
					...
					<h5 class="text-center">Total Product Returned</h5>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-md-6">
			<div class="card bg-danger text-white mb-4">
				<div class="card-body">
					...
					<h5 class="text-center">Total Product Not Return</h5>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-md-6">
		...
		<div class="col-xl-3 col-md-6">
			<div class="card bg-danger text-white mb-4">
				<div class="card-body">
					...
					<h5 class="text-center">Total Party</h5>
				</div>
			</div>
		</div>
		<div class="col-xl-3 col-md-6">
		...
		<div class="col-xl-3 col-md-6">
			<div class="card bg-primary text-white mb-4">
				<div class="card-body">
					...
					<h5 class="text-center">Total Locations</h5>
				</div>
			</div>
		</div>
	</div>
